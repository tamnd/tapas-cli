...
Most of these come down to network reality or how tapas serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

tapas rate-limits like any public site. tapas already paces
...
Where a surface is gated, tapas reads a cookie or token you supply
...
`tapas`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what tapas actually did
