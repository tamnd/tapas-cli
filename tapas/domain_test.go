...
// HTTP behaviour is covered in tapas_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "tapas://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("tapas", "about")
	if err != nil || got.String() != "tapas://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want tapas://page/about", got.String(), err)
	}
}
